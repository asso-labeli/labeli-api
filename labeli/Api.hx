...
@:keep class Api
{
	...
	public function getUser(userId : Int) : Dynamic
	{
	...
	public function getOldUsers() : Array<Dynamic>
	{
		return User.toArray(User.manager.search($type == User.OLD, {orderBy : firstName}));
	}
	...
	public function editGroup(groupId : Int, name : String, description : String, picture : String) : Bool
	{
	...
	public function submitVote(groupId : Int, value : Int) : Bool
	{
		if(!user.logged)
			throw "You don't have rights to do this";
	...
	public function getVotes() : Array<Dynamic>
	{
	...
	public function getMessages(thread : String, since : Float) : Array<Dynamic>
	{
	...
	public function getSurveyData(surveyName : String) : Dynamic
	{
	...
	public function voteForSurvey(surveyName : String, surveyItem : String, value : Bool) : Bool
	{
		if(!user.logged)
			throw "You don't have rights to do this";
